...
bulk_modulus = Function(W, name="bulk modulus").interpolate(1e4*shear_modulus)
...
stokes_solver = CompressibleViscoelasticStokesSolver(z, m, density, approximation,
                                         dt, bcs=stokes_bcs,)
...
# +
# Create output file
output_file = VTKFile("output_k1e4mu.pvd")
output_file.write(z, displacement)
