...
Plane Surface(3) = {2, 1};  // Inner region (r_cmb - r_inner)

MeshSize {4} = 10.0; // Force coarse mesh on all outer boundaries
MeshSize {3} = 0.1; // Fine mesh for CMB and Surface boundaries
MeshSize {2} = 0.1; // Force coarse mesh on all outer boundaries
MeshSize {1} = 1.0; // Force coarse mesh on all outer boundaries
