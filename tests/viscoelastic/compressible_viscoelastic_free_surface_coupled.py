...
#    exit()
    ...
    coupled_solver = CoupledEquationsTimeIntegrator(equations, z, fields, dt, bcs=weak_bcs, mass_terms=mass_terms, solver_parameters=direct_stokes_solver_parameters, strong_bcs=strong_bcs)
